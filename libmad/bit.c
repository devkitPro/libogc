 ...
 */
void mad_bit_init(struct mad_bitptr *bitptr, u8 const *byte)
{
  bitptr->byte  = byte;
  bitptr->cache = 0;
 ...
 */
u32 mad_bit_length(struct mad_bitptr const *begin,
 ...
 */
u8 const *mad_bit_nextbyte(struct mad_bitptr const *bitptr)
{
 ...
 */
void mad_bit_skip(struct mad_bitptr *bitptr, u32 len)
{
 ...
 */
u32 mad_bit_read(struct mad_bitptr *bitptr, u32 len)
{
  register u32 value;
 ...
 */
void mad_bit_write(struct mad_bitptr *bitptr, u32 len,
		   u32 value)
{
  u8 *ptr;
 ...
 */
u16 mad_bit_crc(struct mad_bitptr bitptr, u32 len,
			   u16 init)
{
  register u32 crc;
