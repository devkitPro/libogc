 ...
 *
 * $Id: frame.c,v 1.1.1.1 2004-08-03 13:56:16 wntrmute Exp $
 */
 ...
 */
static
s32 decode_header(struct mad_header *header, struct mad_stream *stream)
{
  u32 index;
 ...
 */
static
s32 free_bitrate(struct mad_stream *stream, struct mad_header const *header)
{
  struct mad_bitptr keep_ptr;
  u32 rate = 0;
  u32 pad_slot, slots_per_frame;
  u8 const *ptr = 0;
 ...
 */
s32 mad_header_decode(struct mad_header *header, struct mad_stream *stream)
{
  register u8 const *ptr, *end;
  u32 pad_slot, N;
 ...
 */
s32 mad_frame_decode(struct mad_frame *frame, struct mad_stream *stream)
{
